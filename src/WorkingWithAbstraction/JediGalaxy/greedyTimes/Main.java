...
package WorkingWithAbstraction.JediGalaxy.greedyTimes;
...
public class Main {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < safe.length; i += 2) {
            String name = safe[i];
            long broika = Long.parseLong(safe[i + 1]);
            ...
            switch (kvoE) {
                case "Gold" -> zlato += broika;
                case "Gem" -> kamuni += broika;
                case "Cash" -> mangizi += broika;
            }
        }
